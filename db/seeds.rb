...
Petsitter.create(user_id: 1, bio: "Hello, I am a full time dog walker in Brooklyn NYC. Previously, I have worked as a zookeeper, in an animal rescue, and multiple vet clinics so your pet is safe with me!", photo: "https://images.pexels.com/photos/17267141/pexels-photo-17267141/free-photo-of-woman-posing-in-floral-dress.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", city: "Brooklyn", day_rate: 85, currently_available: true, my_ideal_pet_sit: "I am available to do in-house pet sits, and board smaller dogs in my home.", full_name: "Beau Lazear")
Petsitter.create(user_id: 3, bio: "Loving caretaker of NYC's furballs!", photo: "https://images.unsplash.com/photo-1611432579699-484f7990b127?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aGVhZHNob3R8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60", city: "Bronx", day_rate: 95, currently_available: true, my_ideal_pet_sit: "Open to all pet sits.", full_name: "Sarah Hubschman")
